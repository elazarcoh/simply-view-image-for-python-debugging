// https://github.com/node-gfx/image-data/blob/1e80ea4a54e8887017b85315e3fa59386946e304/index.js
...
export class ImageData {
    ...
    constructor(data: Uint8ClampedArray, height: number, width2: number);
    constructor(
        width: number | Uint8ClampedArray,
        height: number,
        ...args: any[]
    ) {
