...
suite('Extension Commands Test Suite', () => {
  ...
  test('Open Settings command should work', async () => {
  ...
  test('Open Image Webview command should work', async () => {
    try {
  ...
  test('Watch Refresh command should work without debug session', async () => {
    try {
  ...
  test('Add Expression command should be available', async () => {
    try {
  ...
  test('Debug-dependent commands should handle no-debug gracefully', async () => {
  ...
  test('Configuration-dependent commands should work', async () => {
  ...
  test('Invalid command should not be registered', async () => {
  ...
  test('Command execution should not crash VS Code', async () => {
  ...
  test('Extension should handle command with invalid arguments', async () => {
  ...
  test('Command availability should match enablement conditions', async () => {
