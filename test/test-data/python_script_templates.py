"""
Python templates for test scripts.
This file contains the same templates as the TypeScript version for consistency.
"""

# Basic Python test script for simple debugging scenarios
BASIC_SCRIPT = """import numpy as np
try:
...
COMPLEX_SCRIPT = """import numpy as np
try:
    from PIL import Image
    import matplotlib.pyplot as plt
...
ERROR_TEST_SCRIPT = """import numpy as np
...
PERFORMANCE_SCRIPT = """import numpy as np
import time
...
TENSOR_SCRIPT = """import numpy as np
...
TEMPLATES = {
    ...
    'error': ERROR_TEST_SCRIPT,
    'performance': PERFORMANCE_SCRIPT,
    'tensor': TENSOR_SCRIPT,
    'plot': PLOT_SCRIPT
}

def get_template(name):
    """Get a template by name."""
    return TEMPLATES.get(name, BASIC_SCRIPT)