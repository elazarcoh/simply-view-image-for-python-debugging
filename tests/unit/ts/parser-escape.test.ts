...
describe('parsePythonResult — escaped strings', () => {
  ...
  describe('stripReprQuoting: outer Python repr-quoting is stripped', () => {
    ...
    it('unescapes \\\\quote inside outer-quoted repr', () => {
      // Outer single-quoted repr: 'it\'s' — the \' becomes ' after stripping
      // This arrives as Value('it\'s') after outer-repr unquoting
      // But stringify always uses double quotes, so test with double-outer:
